-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\axi_lite_simpledec\axi_lite_simpledec_pcore.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: axi_lite_simpledec_pcore
-- Source Path: axi_lite_simpledec_pcore
-- Hierarchy Level: 0
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY axi_lite_simpledec_pcore IS
...
END axi_lite_simpledec_pcore;


ARCHITECTURE rtl OF axi_lite_simpledec_pcore IS

  -- Component Declarations
  COMPONENT axi_lite_simpledec_pcore_axi_lite
  ...
  COMPONENT axi_lite_simpledec_pcore_dut
  ...
  FOR ALL : axi_lite_simpledec_pcore_axi_lite
    USE ENTITY work.axi_lite_simpledec_pcore_axi_lite(rtl);

  FOR ALL : axi_lite_simpledec_pcore_dut
    USE ENTITY work.axi_lite_simpledec_pcore_dut(rtl);
  ...
  SIGNAL wr_decFactor_sig                 : std_logic_vector(31 DOWNTO 0);  -- ufix32
...
BEGIN
  u_axi_lite_simpledec_pcore_axi_lite_inst : axi_lite_simpledec_pcore_axi_lite
    PORT MAP( reset_in => reset_in,
              ...
              read_rd_decFactor => rd_decFactor_sig,  -- ufix32
              ...
              write_wr_decFactor => wr_decFactor_sig,  -- ufix32
              reset_internal => reset_internal  -- ufix1
              );

  u_axi_lite_simpledec_pcore_dut_inst : axi_lite_simpledec_pcore_dut
    PORT MAP( din_I => din_I,  -- ufix16
              din_Q => din_Q,  -- ufix16
              strobe_in => strobe_in,  -- ufix1
              wr_decFactor => wr_decFactor_sig,  -- ufix32
              reset => reset,  -- ufix1
              clk => clk,  -- ufix1
