-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\axi_lite_NCO\axi_lite_nco_pcore_axi_lite.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: axi_lite_nco_pcore_axi_lite
-- Source Path: axi_lite_nco_pcore/axi_lite_nco_pcore_axi_lite
-- Hierarchy Level: 1
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY axi_lite_nco_pcore_axi_lite IS
...
END axi_lite_nco_pcore_axi_lite;


ARCHITECTURE rtl OF axi_lite_nco_pcore_axi_lite IS

  -- Component Declarations
  COMPONENT axi_lite_nco_pcore_addr_decoder
  ...
  COMPONENT axi_lite_nco_pcore_axi_lite_module
    PORT( clk_in                          :   IN    std_logic;  -- ufix1
          AXI_Lite_ARESETN                :   IN    std_logic;  -- ufix1
          AXI_Lite_AWADDR                 :   IN    std_logic_vector(31 DOWNTO 0);  -- ufix32
          AXI_Lite_AWVALID                :   IN    std_logic;  -- ufix1
  ...
  FOR ALL : axi_lite_nco_pcore_addr_decoder
    USE ENTITY work.axi_lite_nco_pcore_addr_decoder(rtl);

  FOR ALL : axi_lite_nco_pcore_axi_lite_module
    USE ENTITY work.axi_lite_nco_pcore_axi_lite_module(rtl);
  ...
  SIGNAL inst_wr_NCOinc                   : std_logic_vector(31 DOWNTO 0);  -- ufix32
  SIGNAL inst_wr_debugNCO                 : std_logic;  -- ufix1
...
BEGIN
  u_axi_lite_nco_pcore_addr_decoder_inst : axi_lite_nco_pcore_addr_decoder
    PORT MAP( clk_in => AXI_Lite_ACLK,  -- ufix1
              ...
              read_rd_NCOinc => read_rd_NCOinc,  -- ufix32
              read_rd_debugNCO => read_rd_debugNCO,  -- ufix1
              data_read => top_data_read,  -- ufix32
              write_wr_NCOinc => inst_wr_NCOinc,  -- ufix32
              write_wr_debugNCO => inst_wr_debugNCO  -- ufix1
              );

  u_axi_lite_nco_pcore_axi_lite_module_inst : axi_lite_nco_pcore_axi_lite_module
    PORT MAP( clk_in => AXI_Lite_ACLK,  -- ufix1
  ...
  write_wr_NCOinc <= inst_wr_NCOinc;

  write_wr_debugNCO <= inst_wr_debugNCO;
