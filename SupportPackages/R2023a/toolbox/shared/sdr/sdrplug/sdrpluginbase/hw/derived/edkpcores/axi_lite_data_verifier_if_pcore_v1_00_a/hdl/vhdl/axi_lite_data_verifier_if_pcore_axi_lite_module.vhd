-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/axi_lite_data_verifier_if/axi_lite_data_verifier_if_pcore_axi_lite_module.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: axi_lite_data_verifier_if_pcore_axi_lite_module
-- Source Path: axi_lite_data_verifier_if_pcore/axi_lite_data_verifier_if_pcore_axi_lite/axi_lite_data_verifier_if_pcore_axi_lite_module
-- Hierarchy Level: 2
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY axi_lite_data_verifier_if_pcore_axi_lite_module IS
...
END axi_lite_data_verifier_if_pcore_axi_lite_module;


ARCHITECTURE rtl OF axi_lite_data_verifier_if_pcore_axi_lite_module IS
...
BEGIN
  ...
  axi_rst <=  NOT AXI4_Lite_ARESETN;

  axi_lite_process : PROCESS (axi_clk, axi_rst)
  BEGIN
    IF axi_rst = '1' THEN
  ...
  reg_rdata_process : PROCESS (axi_clk, axi_rst)
  BEGIN
    IF axi_rst = '1' THEN
  ...
  reg_wdata_process : PROCESS (axi_clk, axi_rst)
  BEGIN
    IF axi_rst = '1' THEN
  ...
  reg_waddr_process : PROCESS (axi_clk, axi_rst)
  BEGIN
    IF axi_rst = '1' THEN
  ...
  reg_wr_enb_process : PROCESS (axi_clk, axi_rst)
  BEGIN
    IF axi_rst = '1' THEN
      wr_enb_1 <= '0';
    ELSIF axi_clk'EVENT AND axi_clk = '1' THEN
  ...
  reg_process : PROCESS (axi_clk, axi_rst)
  BEGIN
    IF axi_rst = '1' THEN
      soft_reset <= '0';
    ELSIF axi_clk'EVENT AND axi_clk = '1' THEN
  ...
  reset_internal <= axi_rst OR soft_reset;
