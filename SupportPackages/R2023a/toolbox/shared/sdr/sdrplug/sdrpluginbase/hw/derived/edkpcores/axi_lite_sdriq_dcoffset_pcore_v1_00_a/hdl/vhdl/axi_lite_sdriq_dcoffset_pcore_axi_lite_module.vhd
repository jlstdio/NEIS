-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\axi_lite_sdriq_dcoffset\axi_lite_sdriq_dcoffset_pcore_axi_lite_module.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: axi_lite_sdriq_dcoffset_pcore_axi_lite_module
-- Source Path: axi_lite_sdriq_dcoffset_pcore/axi_lite_sdriq_dcoffset_pcore_axi_lite/axi_lite_sdriq_dcoffset_pcore_axi_lite_module
-- Hierarchy Level: 2
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY axi_lite_sdriq_dcoffset_pcore_axi_lite_module IS
...
END axi_lite_sdriq_dcoffset_pcore_axi_lite_module;


ARCHITECTURE rtl OF axi_lite_sdriq_dcoffset_pcore_axi_lite_module IS
...
BEGIN
  ...
  axi_lite_process : PROCESS (clk, reset_in)
  BEGIN
    IF reset_in = '1' THEN
  ...
  reg_rdata_process : PROCESS (clk, reset_in)
  BEGIN
    IF reset_in = '1' THEN
  ...
  reg_wdata_process : PROCESS (clk, reset_in)
  BEGIN
    IF reset_in = '1' THEN
  ...
  reg_waddr_process : PROCESS (clk, reset_in)
  BEGIN
    IF reset_in = '1' THEN
  ...
  reg_wr_enb_process : PROCESS (clk, reset_in)
  BEGIN
    IF reset_in = '1' THEN
      wr_enb_1 <= '0';
    ELSIF clk'EVENT AND clk = '1' THEN
  ...
  reg_process : PROCESS (clk, reset_in)
  BEGIN
    IF reset_in = '1' THEN
      soft_reset <= '0';
    ELSIF clk'EVENT AND clk = '1' THEN
