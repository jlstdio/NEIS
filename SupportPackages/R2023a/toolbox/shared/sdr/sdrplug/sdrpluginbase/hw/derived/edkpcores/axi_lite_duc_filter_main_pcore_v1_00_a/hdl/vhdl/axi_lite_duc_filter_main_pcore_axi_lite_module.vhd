-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\axi_lite_duc_filter_main\axi_lite_duc_filter_main_pcore_axi_lite_module.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: axi_lite_duc_filter_main_pcore_axi_lite_module
-- Source Path: axi_lite_duc_filter_main_pcore/axi_lite_duc_filter_main_pcore_axi_lite/axi_lite_duc_filter_main_pcore_axi_lite_module
-- Hierarchy Level: 2
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY axi_lite_duc_filter_main_pcore_axi_lite_module IS
...
END axi_lite_duc_filter_main_pcore_axi_lite_module;


ARCHITECTURE rtl OF axi_lite_duc_filter_main_pcore_axi_lite_module IS
...
BEGIN
  ...
  reset_in <=  NOT AXI_Lite_ARESETN;

  axi_lite_process : PROCESS (clk_in, reset_in)
  BEGIN
    IF reset_in = '1' THEN
  ...
  reg_rdata_process : PROCESS (clk_in, reset_in)
  BEGIN
    IF reset_in = '1' THEN
  ...
  reg_wdata_process : PROCESS (clk_in, reset_in)
  BEGIN
    IF reset_in = '1' THEN
  ...
  reg_waddr_process : PROCESS (clk_in, reset_in)
  BEGIN
    IF reset_in = '1' THEN
  ...
  reg_wr_enb_process : PROCESS (clk_in, reset_in)
  BEGIN
    IF reset_in = '1' THEN
      wr_enb_1 <= '0';
    ELSIF clk_in'EVENT AND clk_in = '1' THEN
  ...
  strobe_addr <= '1' WHEN waddr_sel = to_unsigned(2#00000000000000#, 14) ELSE
      '0';
  ...
  reg_process : PROCESS (clk_in, reset_in)
  BEGIN
    IF reset_in = '1' THEN
      soft_reset <= '0';
    ELSIF clk_in'EVENT AND clk_in = '1' THEN
  ...
  reset_internal <= reset_in OR soft_reset;
