-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/axi_lite_data_unpacker/axi_lite_data_unpacker_pcore_addr_decoder.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: axi_lite_data_unpacker_pcore_addr_decoder
-- Source Path: axi_lite_data_unpacker_pcore/axi_lite_data_unpacker_pcore_axi_lite/axi_lite_data_unpacker_pcore_addr_decoder
-- Hierarchy Level: 2
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY axi_lite_data_unpacker_pcore_addr_decoder IS
...
END axi_lite_data_unpacker_pcore_addr_decoder;


ARCHITECTURE rtl OF axi_lite_data_unpacker_pcore_addr_decoder IS
