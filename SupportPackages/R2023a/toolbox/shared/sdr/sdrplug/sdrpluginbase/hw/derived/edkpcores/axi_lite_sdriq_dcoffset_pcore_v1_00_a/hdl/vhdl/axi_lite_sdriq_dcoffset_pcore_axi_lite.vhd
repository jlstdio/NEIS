-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\axi_lite_sdriq_dcoffset\axi_lite_sdriq_dcoffset_pcore_axi_lite.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: axi_lite_sdriq_dcoffset_pcore_axi_lite
-- Source Path: axi_lite_sdriq_dcoffset_pcore/axi_lite_sdriq_dcoffset_pcore_axi_lite
-- Hierarchy Level: 1
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY axi_lite_sdriq_dcoffset_pcore_axi_lite IS
...
END axi_lite_sdriq_dcoffset_pcore_axi_lite;


ARCHITECTURE rtl OF axi_lite_sdriq_dcoffset_pcore_axi_lite IS

  -- Component Declarations
  COMPONENT axi_lite_sdriq_dcoffset_pcore_addr_decoder
  ...
  COMPONENT axi_lite_sdriq_dcoffset_pcore_axi_lite_module
    PORT( clk                             :   IN    std_logic;  -- ufix1
          AXI_Lite_ARESETN                :   IN    std_logic;  -- ufix1
          AXI_Lite_AWADDR                 :   IN    std_logic_vector(31 DOWNTO 0);  -- ufix32
          AXI_Lite_AWVALID                :   IN    std_logic;  -- ufix1
  ...
  FOR ALL : axi_lite_sdriq_dcoffset_pcore_addr_decoder
    USE ENTITY work.axi_lite_sdriq_dcoffset_pcore_addr_decoder(rtl);

  FOR ALL : axi_lite_sdriq_dcoffset_pcore_axi_lite_module
    USE ENTITY work.axi_lite_sdriq_dcoffset_pcore_axi_lite_module(rtl);
  ...
  SIGNAL inst_wr_IQbal                    : std_logic_vector(31 DOWNTO 0);  -- ufix32
  SIGNAL inst_wr_iqbal_dcoffbypass        : std_logic_vector(1 DOWNTO 0);  -- ufix2
  SIGNAL inst_wr_dcoffset                 : std_logic_vector(31 DOWNTO 0);  -- ufix32
...
BEGIN
  u_axi_lite_sdriq_dcoffset_pcore_addr_decoder_inst : axi_lite_sdriq_dcoffset_pcore_addr_decoder
    PORT MAP( clk => AXI_Lite_ACLK,  -- ufix1
              ...
              read_rd_IQbal => read_rd_IQbal,  -- ufix32
              read_rd_iqbal_dcoffbypass => read_rd_iqbal_dcoffbypass,  -- ufix2
              read_rd_dcoffset => read_rd_dcoffset,  -- ufix32
              data_read => top_data_read,  -- ufix32
              write_wr_IQbal => inst_wr_IQbal,  -- ufix32
              write_wr_iqbal_dcoffbypass => inst_wr_iqbal_dcoffbypass,  -- ufix2
              write_wr_dcoffset => inst_wr_dcoffset  -- ufix32
              );

  u_axi_lite_sdriq_dcoffset_pcore_axi_lite_module_inst : axi_lite_sdriq_dcoffset_pcore_axi_lite_module
    PORT MAP( clk => AXI_Lite_ACLK,  -- ufix1
  ...
  write_wr_IQbal <= inst_wr_IQbal;

  write_wr_iqbal_dcoffbypass <= inst_wr_iqbal_dcoffbypass;

  write_wr_dcoffset <= inst_wr_dcoffset;
