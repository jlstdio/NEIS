-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\axi_lite_ddc_filter_main\axi_lite_ddc_filter_main_pcore_addr_decoder.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: axi_lite_ddc_filter_main_pcore_addr_decoder
-- Source Path: axi_lite_ddc_filter_main_pcore/axi_lite_ddc_filter_main_pcore_axi_lite/axi_lite_ddc_filter_main_pcore_addr_decoder
-- Hierarchy Level: 2
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY axi_lite_ddc_filter_main_pcore_addr_decoder IS
...
END axi_lite_ddc_filter_main_pcore_addr_decoder;


ARCHITECTURE rtl OF axi_lite_ddc_filter_main_pcore_addr_decoder IS
...
BEGIN
  ...
  decode_sel_rd_control_reg <= '1' WHEN addr_sel_unsigned = 65 ELSE
      '0';
  ...
  decode_sel_wr_control_reg <= '1' WHEN addr_sel_unsigned = 64 ELSE
      '0';
