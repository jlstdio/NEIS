-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/axi_lite_data_unpacker/axi_lite_data_unpacker_pcore.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: axi_lite_data_unpacker_pcore
-- Source Path: axi_lite_data_unpacker_pcore
-- Hierarchy Level: 0
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY axi_lite_data_unpacker_pcore IS
  GENERIC(
...
END axi_lite_data_unpacker_pcore;


ARCHITECTURE rtl OF axi_lite_data_unpacker_pcore IS

  -- Component Declarations
  COMPONENT axi_lite_data_unpacker_pcore_axi_lite
  ...
  COMPONENT axi_lite_data_unpacker_pcore_dut
    GENERIC(
        bit_width : integer := 64
    );
  ...
  FOR ALL : axi_lite_data_unpacker_pcore_axi_lite
    USE ENTITY work.axi_lite_data_unpacker_pcore_axi_lite(rtl);

  FOR ALL : axi_lite_data_unpacker_pcore_dut
    USE ENTITY work.axi_lite_data_unpacker_pcore_dut(rtl);
...
BEGIN
  u_axi_lite_data_unpacker_pcore_axi_lite_inst : axi_lite_data_unpacker_pcore_axi_lite
  ...
  u_axi_lite_data_unpacker_pcore_dut_inst : axi_lite_data_unpacker_pcore_dut
    GENERIC MAP(
        bit_width => bit_width
    )
