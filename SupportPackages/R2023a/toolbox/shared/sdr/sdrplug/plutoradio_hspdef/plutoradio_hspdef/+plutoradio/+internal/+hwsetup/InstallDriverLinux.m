classdef InstallDriverLinux < plutoradio.internal.hwsetup.InstallDriver
...
%   Copyright 2017 The MathWorks, Inc.
  ...
  methods
    function obj = InstallDriverLinux(varargin)
      ...
      obj.Title.Text = message('plutoradio:hwsetup:InstallDriverLinux_Title').getString;
      
      obj.InfoText1.Position = [20 340 400 30];
      obj.InfoText1.Text = message('plutoradio:hwsetup:InstallDriverLinux_InfoText1').getString;

      obj.InfoText2.Position = [20 290 400 50];
      obj.InfoText2.Text = message('plutoradio:hwsetup:InstallDriverLinux_InfoText2').getString;
      
      obj.HelpText.AboutSelection = '';
      obj.HelpText.WhatToConsider = message('plutoradio:hwsetup:InstallDriverLinux_WhatToConsider').getString;
    end
