...
%
blkStruct.Name    = sprintf('Communications Toolbox Support Package for\nADALM-PLUTO Radio');
blkStruct.OpenFcn = 'plutoradiolib';
blkStruct.MaskInitialization = '';
blkStruct.MaskDisplay = '';

Browser(1).Library = 'plutoradiolib';
Browser(1).Name    = 'Communications Toolbox Support Package for ADALM-PLUTO Radio';
